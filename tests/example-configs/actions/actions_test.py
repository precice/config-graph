...
from precice_config_graph.nodes import DataType, Direction, TimingType, CouplingSchemeType, ActionType, M2NType, \
    MappingConstraint, MappingMethod
...
def test_graph():
    ...
    n_propagator_receive_mesh = n.ReceiveMeshNode(
        n_propagator_participant, from_participant=n_generator_participant, mesh=n_generator_mesh, api_access=False
    )

    n_mapping = n.MappingNode(
        n_propagator_participant, Direction.READ, False, MappingMethod.NEAREST_NEIGHBOR,
