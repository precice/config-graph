...
from precice_config_graph.nodes import DataType, Direction, M2NType, MappingMethode, MappingConstraint
...
def test_graph():
    ...
    n_participant_nastin.mappings = [
        n.MappingNode(parent_participant=n_participant_nastin, direction=Direction.WRITE, just_in_time=False,
                      methode=MappingMethode.NEAREST_NEIGHBOR, constraint=MappingConstraint.CONSERVATIVE,
