...
def test_graph():
    ...
    n_participant_propagator = n.ParticipantNode("Propagator", None, None, None,
                                                 ...
                                                 None, None)
    # Write Data
    n_write_data_generator_color_generator_mesh = n.WriteDataNode(n_participant_generator, n_data_color,
                                                                  n_mesh_generator)
    n_participant_generator.write_data = [n_write_data_generator_color_generator_mesh]

    # Read Data
    n_read_data_propagator_color_propagator_mesh = n.ReadDataNode(n_participant_propagator, n_data_color,
                                                                  n_mesh_propagator)
    ...
    edges += [
        (n_participant_propagator, n_exchange_color_generator_mesh_generator_propagator, Edge.EXCHANGE__EXCHANGES_TO)]
    ...
    edges += [
        (n_coupling_scheme_generator_propagator, n_participant_generator, Edge.COUPLING_SCHEME__PARTICIPANT_FIRST)]

    # Coupling-scheme -- participant
    edges += [
        (n_coupling_scheme_generator_propagator, n_participant_propagator, Edge.COUPLING_SCHEME__PARTICIPANT_SECOND)]
